--------------------------------------------------------
-- Archivo creado  - miércoles-noviembre-16-2022   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "TOPHER"."DETALLE_UNIVERSIDAD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "TOPHER"."MOVILIDAD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "TOPHER"."POSTULACION_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence PREGUNTA_CONVOCATORIA_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "TOPHER"."PREGUNTA_CONVOCATORIA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence PREGUNTA_SEQ1
--------------------------------------------------------

   CREATE SEQUENCE  "TOPHER"."PREGUNTA_SEQ1"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence RESPUESTA_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "TOPHER"."RESPUESTA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence S_CONVOCATORIA_AINCR
--------------------------------------------------------

   CREATE SEQUENCE  "TOPHER"."S_CONVOCATORIA_AINCR"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 22 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into TOPHER.CONVOCATORIA (ID_CONVOCATORIA,NOMBRE,FECHA_INICIO,FECHA_FIN,ESTADO,MIN_CREDITO_SCT,MAX_CREDITO_SCT,NOTIFICACION,RAMOS_REPROBADOS,ID_PROGRAMA) values ('1','Convocatoria Test 1',to_date('09-11-2022','DD-MM-YYYY'),to_date('16-11-2022','DD-MM-YYYY'),'Activa','1','99','No','6','4');
Insert into TOPHER.CONVOCATORIA (ID_CONVOCATORIA,NOMBRE,FECHA_INICIO,FECHA_FIN,ESTADO,MIN_CREDITO_SCT,MAX_CREDITO_SCT,NOTIFICACION,RAMOS_REPROBADOS,ID_PROGRAMA) values ('3','conv test 2',to_date('15-11-2023','DD-MM-YYYY'),to_date('18-11-2022','DD-MM-YYYY'),'Próximamente','1','99','No','5','4');
Insert into TOPHER.CONVOCATORIA (ID_CONVOCATORIA,NOMBRE,FECHA_INICIO,FECHA_FIN,ESTADO,MIN_CREDITO_SCT,MAX_CREDITO_SCT,NOTIFICACION,RAMOS_REPROBADOS,ID_PROGRAMA) values ('4','a',to_date('02-02-2022','DD-MM-YYYY'),to_date('03-02-2022','DD-MM-YYYY'),'Activa','1','99','No','5','4');
...
SET DEFINE OFF;
Insert into TOPHER.MOVILIDAD (ID_MOVILIDAD,FECHA_INICIO,FECHA_FIN,SEMESTRE,ESTADO,ID_ESTUDIANTE,ID_CONVOCATORIA) values ('5',null,null,null,'En preparación','1','1');
...
SET DEFINE OFF;
Insert into TOPHER.POSTULACION (ID_POSTULACION,NACIONALIDAD,N_TELEFONO,EMAIL_PERSONAL,NIVEL_INGLES,IDIOMA_2,PRIMERA_OPCION,SEGUNDA_OPCION,TERCERA_OPCION,SELECCION,ESTADO,ID_CONVOCATORIA,ID_MOVILIDAD,ID_ESTUDIANTE,CONFIRMACION) values ('21','Chilena','989896187','chrisparedeslbz@gmail.com','Inglés A1','1','1','1','1','117','Aceptado con Beca','1','0','1','Confirmado');
Insert into TOPHER.POSTULACION (ID_POSTULACION,NACIONALIDAD,N_TELEFONO,EMAIL_PERSONAL,NIVEL_INGLES,IDIOMA_2,PRIMERA_OPCION,SEGUNDA_OPCION,TERCERA_OPCION,SELECCION,ESTADO,ID_CONVOCATORIA,ID_MOVILIDAD,ID_ESTUDIANTE,CONFIRMACION) values ('41','Chilena','989896187','cparedes16@alumnos.utalca.cl','Inglés B2','2','36','45','51','0','En espera','4','0','1','Sin aceptar');
REM INSERTING into TOPHER.PREGUNTA
SET DEFINE OFF;
Insert into TOPHER.PREGUNTA (ID_PREGUNTA,TIPO,TITULO,TIPO_INPUT,ESTADO) values ('1','Individual','Pregunta Input Simple','Texto','Activo');
Insert into TOPHER.PREGUNTA (ID_PREGUNTA,TIPO,TITULO,TIPO_INPUT,ESTADO) values ('2','Individual','Pregunta Simple Numero','Texto','En espera');
Insert into TOPHER.PREGUNTA (ID_PREGUNTA,TIPO,TITULO,TIPO_INPUT,ESTADO) values ('3','Individual','Nombre Social','Texto','Activo');
REM INSERTING into TOPHER.PREGUNTA_CONVOCATORIA
SET DEFINE OFF;
Insert into TOPHER.PREGUNTA_CONVOCATORIA (ID_DETALLE_PREGUNTA,ID_PREGUNTA,ID_CONVOCATORIA) values ('1','3','2');
Insert into TOPHER.PREGUNTA_CONVOCATORIA (ID_DETALLE_PREGUNTA,ID_PREGUNTA,ID_CONVOCATORIA) values ('2','3','3');
Insert into TOPHER.PREGUNTA_CONVOCATORIA (ID_DETALLE_PREGUNTA,ID_PREGUNTA,ID_CONVOCATORIA) values ('3','3','4');
...
Insert into TOPHER.PROGRAMA (ID_PROGRAMA,NOMBRE,DESCRIPCION,ESTADO) values ('1','Beca Abate Molina','Dummy ID1','En espera');
...
SET DEFINE OFF;
Insert into TOPHER.RESPUESTA (ID_RESPUESTA,RESPUESTA,ID_PREGUNTA,ID_POSTULACION) values ('1','Topher','3','41');
...
--------------------------------------------------------
--  DDL for Trigger PREGUNTA_TRG1
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "TOPHER"."PREGUNTA_TRG1" 
BEFORE INSERT ON PREGUNTA 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.ID_PREGUNTA IS NULL THEN
      SELECT PREGUNTA_SEQ1.NEXTVAL INTO :NEW.ID_PREGUNTA FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;
/
ALTER TRIGGER "TOPHER"."PREGUNTA_TRG1" ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "TOPHER"."PREGUNTA" MODIFY ("ESTADO" NOT NULL ENABLE);
--------------------------------------------------------
