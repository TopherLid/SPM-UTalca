...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-11-2022 a las 14:56:49
...
INSERT INTO `estudiante` (`ID_ESTUDIANTE`, `ID_USUARIO`, `RUT`, `NOMBRE`, `MATRICULA`, `NACIMIENTO`, `EMAIL_INSTITUCIONAL`, `ESTUDIANTE_REGULAR`, `CREDITOS_APROBADOS`, `RAMOS_REPROBADOS`, `DEUDOR_DAFE`, `DEUDOR_BIBLIOTECA`, `ID_CARRERA`, `POS`, `PORCENTAJE`, `PAT`, `PM`) VALUES
(1, 19718582, 197185821, 'Christopher Andrés Paredes López', 2016419076, '1998-01-02', 'cparedes16@alumnos.utalca.cl', 'Si', 210, 1, 'No', 'No', 419, 1, 100, 5.2, 2),
(2, 19701115, 197011157, 'Ignacio Antonio Orellana Ibarra', 2017419021, '1998-09-02', 'iorellana17@alumnos.utalca.cl', 'Si', 250, 0, 'No', 'No', 0, 1, 1, 5.9, 2);
...
CREATE TABLE `opciones_preg_multiple` (
  `ID_OPCIONES_PM` int(38) NOT NULL,
...
ALTER TABLE `detalle_universidad`
  ...
  ADD KEY `ID_UNIVERSIDAD` (`ID_UNIVERSIDAD`,`ID_PROGRAMA`);
...
ALTER TABLE `postulacion`
  ...
  ADD KEY `IDIOMA_2` (`IDIOMA_2`,`1RA_OPCION`,`2DA_OPCION`,`3RA_OPCION`,`SELECCION`,`ID_CONVOCATORIA`,`ID_MOVILIDAD`,`ID_ESTUDIANTE`);
...
ALTER TABLE `pregunta_convocatoria`
  ...
  ADD KEY `ID_PREGUNTA` (`ID_PREGUNTA`,`ID_CONVOCATORIA`);
...
ALTER TABLE `respuesta`
  ...
  ADD KEY `ID_PREGUNTA` (`ID_PREGUNTA`,`ID_POSTULACION`);
...
--
ALTER TABLE `opciones_preg_multiple`
  MODIFY `ID_OPCIONES_PM` int(38) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
