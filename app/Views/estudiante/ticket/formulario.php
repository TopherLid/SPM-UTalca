    ...
    <div class="container">
        ...
        <div class="d-grid gap-2">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <input class="form-control" type="file" name="antecedente" size="20" required>
                </div>
            </div>
            <div class="row">
                <label class="col-md-4 control-label">Carta de Interés <span style="color:#ff0000;">(*)</span></label>
                <div class="col-md-8">
                    <input class="form-control" type="file" name="cinteres" size="20" required>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <input class="form-control" type="file" name="verificador" size="20" required>
